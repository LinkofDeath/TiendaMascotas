...
from .views import inicio, registro, nosotros, admin_productos
...
from .views import obtener_productos, eliminar_producto_en_bodega, ropa, eliminar_producto_en_carrito, agregar_producto_al_carrito
